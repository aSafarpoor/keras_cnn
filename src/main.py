...
parser.add_argument('--hdim',default=112,type=int)
parser.add_argument('--wdim',default=112,type=int)
parser.add_argument('--frame_num',default=250,type=int)
...
def main():
    ...
    params = {'dim': ( args.frame_num,args.hdim,args.wdim,3),
